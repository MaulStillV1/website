...
const values = {
    ...
    "🍈": 1800,
    "🥭": 2200,
    "💴": 1000000, // Nilai jackpot yang lebih tinggi
    "🍎": 600,
    "🍊": 700,
    "🍐": 800,
    "🍔": 1000,
...
function spin() {
    ...
    function determineResult() {
        ...
        if (Math.random() < jackpotChance) {
            ...
            winAmount = values["💴"] + 1000000;
            result.innerText = `Jackpot! Anda mendapatkan tambahan Rp 1.000.000!`;
            jackpotSpinCount = 0;
        } else {
    ...
    animateSpin(slot1, 500);
    animateSpin(slot2, 1000);
    animateSpin(slot3, 1500);
}
